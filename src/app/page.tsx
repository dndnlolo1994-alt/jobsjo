            ...
            >
              {JORDAN_CITIES.map((city) => (
                <Link
                  ...
                  className="flex-shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-full bg-[var(--surface)] border border-[var(--border)] text-sm font-semibold text-[var(--text)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md hover:border-primary-400 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-950/20"
                >
                  <span>📍</span>
                  <span>{city}</span>
                  {cityCounts[city] ? (
            ...
            {JOB_CATEGORIES.map((cat) => {
              ...
              return (
                <Link
                  ...
                  className="rounded-2xl border p-5 text-center font-semibold text-sm bg-white/95 border-blue-100/60 text-gray-800 dark:bg-navy-900/90 dark:border-navy-800/80 dark:text-gray-100 backdrop-blur-md shadow-sm transition-all duration-200 hover:-translate-y-1 hover:bg-primary-50 hover:border-primary-200 hover:text-primary-700 dark:hover:bg-primary-950/40 dark:hover:border-primary-800/60 dark:hover:text-primary-400"
                >
