      ...
      {showUpgrade && (
        <div className="card-pad mb-5 bg-emerald-50/40 border border-emerald-100">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="font-bold text-navy-900">ترقية إلى باقة Plus: عرض عيد الاستقلال 2 دينار شهرياً</h2>
          </div>
          <p className="text-sm text-navy-600 leading-7 mb-3">
            السعر الأساسي 4 دنانير شهرياً. العرض الحالي يفعّل الصورة الشخصية على سيرتك الذاتية، تنزيل PDF بدون رسوم، نسخة إنجليزية كاملة، وتقديم غير محدود على الوظائف.
          </p>
