    ...
    <div className="bg-[var(--color-bg)] min-h-screen text-[var(--color-text-main)] py-12">
      ...
      <section className="relative overflow-hidden py-16 md:py-24 mb-16 rounded-3xl container-jo text-white" style={{ background: "var(--gradient-hero)" }}>
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4">
          ...
          <p className="text-base md:text-lg text-blue-100 max-w-2xl mx-auto leading-relaxed">
            نسعى لتمكين الكفاءات الأردنية وتسهيل وصولها لفرص العمل المحلية المناسبة بكل سهولة وموثوقية، دون تعقيدات وبأحدث التقنيات الرقمية.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-stretch">
          <FadeInSection className="card card-pad flex flex-col justify-between" delay={100}>
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                توفير بيئة توظيف رقمية ذكية ومباشرة تربط الباحثين عن عمل في الأردن بأصحاب الشركات والمنشآت. نهدف إلى تقليل الفجوة في سوق العمل الأردني من خلال تقديم أدوات احترافية مجانية، مثل منشئ السيرة الذاتية الذكي، ومسارات التقديم المباشر، دون أي وساطات أو رسوم خفية.
              </p>
            </div>
          ...
          <FadeInSection className="card card-pad flex flex-col justify-between" delay={200}>
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                أن نكون المنصة الأولى والخيار المفضل للتوظيف في الأردن، مساهمين بفعالية في خفض معدلات البطالة وتسهيل نمو الأعمال المحلية عن طريق توفير قنوات اتصال سلسة وموثوقة بنسبة 100% بين جميع الأطراف في كافة المحافظات من الشمال إلى الجنوب.
              </p>
            </div>
      ...
      <section className="container-jo mb-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { title: "الأمان والموثوقية", desc: "نفحص الإعلانات لضمان حماية خصوصية بيانات المستخدمين من أي استغلال.", icon: "🛡️" },
          ].map((val, idx) => (
      ...
      <section className="container-jo mb-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: "وظائف محلية موثقة", desc: "فرص عمل حقيقية في الأردن يتم تحديثها يومياً والتحقق من صحتها وجديتها.", icon: "✅" },
      ...
      <section className="container-jo mb-24">
        ...
        <div className="card card-pad max-w-3xl mx-auto text-center">
          <p className="leading-relaxed text-gray-600 dark:text-gray-300">
            تأسست منصة <strong>جوبز الأردن</strong> بجهود كفاءات أردنية شابة، تهدف لتقديم نموذج مبتكر ومستقل لأسواق التوظيف المحلية. نحن نؤمن بأن الوصول لفرصة عمل كريمة يجب أن يكون حقاً بسيطاً وسهلاً ومتاحاً للجميع مجاناً وبأعلى جودة ممكنة. نعمل باستمرار على تطوير خوارزميات المطابقة وتحسين أمان البيانات لنضمن لكم تجربة فريدة.
          </p>
        </div>
      </section>
