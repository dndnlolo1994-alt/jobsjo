...
export default function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="card-pad grid sm:grid-cols-2 gap-4 shadow-xl">
      {error && (
        <div className="sm:col-span-2 bg-red-50 border border-red-200 text-red-800 dark:bg-red-950/35 dark:border-red-800/60 dark:text-red-100 text-sm p-4 rounded-xl flex items-start gap-2 animate-shake">
      ...
      <div className="sm:col-span-2">
        <label className="label font-semibold mb-1">الاسم الكامل</label>
        <input 
      ...
      <div>
        <label className="label font-semibold mb-1">رقم الهاتف</label>
        <input 
          className="input w-full focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10" 
          name="phone" 
          type="tel" 
      ...
      <div>
        <label className="label font-semibold mb-1">كلمة المرور</label>
      ...
      <div className="sm:col-span-2">
        <label className="label font-semibold mb-1">نوع الحساب</label>
        <select 
          className="input w-full focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10" 
          name="role" 
          disabled={loading}
      ...
      <label className="sm:col-span-2 flex items-center gap-2 text-sm text-[color:var(--text)] select-none">
        <input 
          name="acceptTerms" 
          type="checkbox" 
          value="on"
